...
HEAD_OFFSET = (0, -190)
LEG_PREFIX = 'legs'
LEG_OFFSET = (0,50) # move legs lower than the center
...
def draw_turtle(shell_shape, spot_count, spot_color, spot_rgb,
    ...
    # draw the head and legs
    draw_centered(turtle, component('', prefix=HEAD_PREFIX), leg_rgb, offset=HEAD_OFFSET)
    draw_centered(turtle, component(leg_shape, prefix=LEG_PREFIX),
                  leg_rgb, offset=LEG_OFFSET)
            ...
            for leg_shape in LEG_SHAPES:
                for leg_color, leg_rgb in LEG_COLORS.items():
                    ...
                    turtle.save(os.path.dirname(__file__) + '/' + OUTPUT_DIR
                                ...
                                + spot_color + '_' + leg_shape + '_' + leg_color + OUTPUT_FILE_TYPE)
